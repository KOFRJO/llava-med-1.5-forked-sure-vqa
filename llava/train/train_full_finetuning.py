...
def train(attn_implementation=None):
    ...
    # THIS IS JUDT A CODE TO TEST THE MODEL / ONLY SOME PARAMETERS WILL BE USED IF BELOW CODE IS USED
    # ########### REMOVE LATER ###########  
    # # Initialize a flag to track if all parameters require gradients
    ...
    #         # Optionally, you can break the loop if you find a parameter that does not require grad

    # if all_require_grad:
    #     print("All parameters require gradients.")
    # else:
    #     print("Not all parameters require gradients.")
    ########### REMOVE LATER ########### 
    ...
    if training_args.lora_enable:
        ...
        # save the weights like this otherwise trainer.save_model or safe_save_model_for_hf_trainer doesnt really save the model checkpoint
